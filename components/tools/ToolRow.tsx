...
export function ToolRow({ tool }: { tool: ToolListItem }) {
  ...
  return (
    <div
      className="group relative flex items-center gap-4 border-b"
    ...
    >
      {/* ── Clickable link area (everything except the compare button) ── */}
      <Link
      ...
      {/* ── Compare select button — outside the Link ── */}
